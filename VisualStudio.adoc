...
|代码辅助 |- |[Yellow-background]#Alt + Enter#
...
|导航到（ReSharper） |- |[Yellow-background]#Alt + `#
|导航到（VisualStudio） |[Yellow-background]#Ctrl + 逗号(,)# |-
|GotoType（SearchEverywhere） |- |[Yellow-background]#Ctrl + T#
|Refactor |- |[Yellow-background]#Ctrl + Shift + R#
|Generate |- |[Yellow-background]#Alt + Insert#
