...
+
特殊选项：squash
用这个选项指定分支的合并，就可以把所有汇合的提交添加到分支上。主要使用的场合：
...
.. 方法一，参照: https://help.github.com/articles/changing-author-info/
...
.. 方法二，参照：http://stackoverflow.com/questions/3042437/change-commit-author-at-one-specific-commit
+
----
